...
const _CAUSE_MAP={"3m추락":"추락","40~50m추락":"추락","5m추락":"추락","7m추락":"추락","강우로인한":"조난","강풍넘어짐":"넘어짐","강풍으로넘어짐":"넘어짐","개인질환":"심정지","계단에서구름":"넘어짐","고립":"조난","고무패들걸려넘어짐":"넘어짐","고사목":"낙석","고사목(강풍의한전도)":"낙석","고혈당추정":"심정지","공황장애및지병":"무리한산행","과도한스트레스":"무리한산행","과로":"심정지","굴러떨어짐":"넘어짐","급체":"무리한산행","기립성저혈압":"심정지","기상악화":"조난","기저질환":"심정지","기저질환(천식)":"심정지","기저질환(한랭질환)":"심정지","기타":"기타","길을잃음":"조난","길잃음":"조난","낙빙":"낙석","낙상":"넘어짐","낙상(돌부리)":"넘어짐","낙석":"낙석","낙석(탐방객)":"낙석","내과질환":"심정지","넘어져구름":"넘어짐","넘어져추락":"넘어짐","넘어짐":"넘어짐","넘어짐(계단)":"넘어짐","넘어짐(낙상)":"넘어짐","넘어짐(너덜)":"넘어짐","넘어짐(돌)":"넘어짐","넘어짐(돌계단)":"넘어짐","넘어짐(비탐)":"넘어짐","넘어짐(지병)":"넘어짐","넘어짐(추정)":"넘어짐","노면단차":"넘어짐","노후된시설물":"넘어짐","눈미끄러짐":"넘어짐","돌깔림사고":"넘어짐","돌밝고넘어짐":"넘어짐","돌밝고삐긋":"넘어짐","돌밟고미끄러짐":"넘어짐","돌밟고삐끗":"넘어짐","돌탑":"낙석","동·식물":"벌쏘임","무리하산행":"무리한산행","무리한등반":"무리한산행","무리한산행":"무리한산행","무리한산행(비)":"무리한산행","무리한산행(비탐)":"무리한산행","무리한산행(지병)":"심정지","무리한산행(폭설)":"조난","무리한산행(폭염)":"무리한산행","무리한신행":"무리한산행","미끄러짐":"넘어짐","미끄러짐(결빙구간)":"넘어짐","미끄러짐(눈)":"넘어짐","미끄러짐(눈길)":"넘어짐","미끄러짐(비)":"넘어짐","미끄러짐(빗길)":"넘어짐","미끄러짐(빙판)":"넘어짐","미상":"심정지","바닥단차":"넘어짐","바위를잘못밝아미끄러짐":"넘어짐","발목골절":"넘어짐","발목부상":"넘어짐","발목염좌":"넘어짐","발목접질림":"넘어짐","뱀물림":"벌쏘임","벌쏘임":"벌쏘임","벌쏘임(비탐)":"벌쏘임","벌쏘임및넘어짐":"벌쏘임","보강재걸려넘어짐":"넘어짐","복부통증,토혈":"심정지","부정맥(약복용)":"심정지","부주의":"넘어짐","부주의(고립)":"조난","부주의(낙상)":"넘어짐","부주의(비탐)":"조난","부주의(사면아래)":"넘어짐","부주의(추락)":"추락","부주의및추락":"추락","불법산행":"조난","빗길미끄러짐":"넘어짐","사망(좌표추정)":"심정지","산행준비미흡":"무리한산행","산행중연락두절":"조난","실족":"넘어짐","실족(비탐)":"넘어짐","실족(빗길)":"넘어짐","실족염좌":"넘어짐","실종(비탐)":"조난","실종신고(버섯)":"조난","실종자수색":"조난","실종자수색(폭설)":"조난","심정지":"심정지","심혈관질환(추정)":"심정지","쓰러짐":"심정지","어깨팔골":"넘어짐","원인미상":"심정지","음주":"무리한산행","음주넘어짐":"넘어짐","의식,호흡없음":"심정지","의식소실":"심정지","이석증추정":"무리한산행","자살추정":"자살추정","장비미숙":"조난","저체온증":"조난","저혈당":"심정지","저혈압쓰러짐":"심정지","접질림":"넘어짐","접질림(낙상)":"넘어짐","조난":"조난","조난(길잃음)":"조난","조난(비탐)":"조난","주취자":"무리한산행","지병":"심정지","지병(부정맥)":"심정지","추락":"추락","추락(10m)":"추락","추락(낙석)":"추락","추락(비탐)":"추락","추락(빙벽)":"추락","추락(출입금지)":"추락","추락(헬기)":"추락","추락10m":"추락","추락3m":"추락","탈진,발목염좌":"무리한산행","탈출로고립":"조난","탐방로이탈계곡진입":"조난","폭설":"조난","폭설실종":"조난","하강로프꼬임":"추락","하강로프부족":"추락","해충":"벌쏘임","헛디딤":"넘어짐","호흡곤란":"심정지","흉통":"심정지","흔들바위밀다가":"넘어짐"};
const _CAUSE_CATS=['넘어짐','무리한산행','추락','심정지','조난','벌쏘임','낙석','자살추정','기타'];
// 사고원인 원문 → 9개 대표 분류. 매핑표 우선 → 키워드 추정 → 그래도 없으면 기타.
function _causeCanon(s){
  const raw=String(s||'').trim();if(!raw)return '';
  const k=raw.replace(/\([^)]*\)/g,'').replace(/\s+/g,'').trim();
  if(_CAUSE_MAP[k])return _CAUSE_MAP[k];
  if(/추락|떨어/.test(k))return '추락';
  if(/벌|뱀|해충|물림|쏘/.test(k))return '벌쏘임';
  if(/낙석|낙빙|고사목|돌탑/.test(k))return '낙석';
  if(/자살|변사/.test(k))return '자살추정';
  if(/조난|고립|실종|길잃|길을잃|연락두절|수색/.test(k))return '조난';
  if(/심정지|심장|의식|호흡|질환|지병|저혈|고혈|부정맥|쓰러|사망|과로/.test(k))return '심정지';
  if(/넘어|미끄|실족|낙상|접질|헛디|삐끗|삐긋|골절|염좌/.test(k))return '넘어짐';
  if(/무리|탈진|음주|급체|저체온|산행/.test(k))return '무리한산행';
  return '기타';
}
