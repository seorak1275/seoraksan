...
- **app.map.js** (1.7k줄): `openApp`/`switchTab`(하단탭 nv1~4, nv4=담당 업무함 표시조건) · `showV`/`rMaps` · 상황판(`openBoard` — v-board를 body로 이동, `_createBoardMap`, `toggleBoardMapType`) · 공원경계(`_drawParkBoundary`) · `_esc`/`_escq` · `_showAdminDenied`
